...
class CodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create code" do
    assert_difference('Code.count') do
      post codes_url, params: { code: { assignment_name: @code.assignment_name, student_id: @code.student_id } }
    end
  ...
  test "should update code" do
    patch code_url(@code), params: { code: { assignment_name: @code.assignment_name, student_id: @code.student_id } }
